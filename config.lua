...
lvim.keys.normal_mode["<leader>r"] = [[:w !python<CR>]]
lvim.keys.normal_mode["<S-i>"] = "10k"
lvim.keys.normal_mode["<S-k>"] = "10j"
...
pcall(function() require("dap-python").setup("/opt/homebrew/anaconda3/envs/MLops/bin/python") end)
